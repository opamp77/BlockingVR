...
ULightHandleBase::ULightHandleBase(const FObjectInitializer& ObjectInitializer)
...
void ULightHandleBase::DrawDebugMeshes(void) //virtual base
{
}

FVector ULightHandleBase::GetHMDWorldLocation(void)
{
...
void ULightHandleBase::TickComponent(float DeltaTime,enum ELevelTick TickType,FActorComponentTickFunction * ThisTickFunction)
{
